...
Executes the **cia-analyzer** skill: read `.cursor/skills/cia-analyzer/SKILL.md` and follow the procedure.
...
1. Execute:
   ```bash
   python .cursor/skills/cia-analyzer/scripts/cia_analyzer.py $ARGUMENTS
   ```
