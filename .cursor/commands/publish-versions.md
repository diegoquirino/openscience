...
Executes the **version-publisher** skill: read `.cursor/skills/version-publisher/SKILL.md` and follow the procedure.
...
2. Execute:
   ```bash
   python .cursor/skills/version-publisher/scripts/publish_versions.py $ARGUMENTS
   ```
