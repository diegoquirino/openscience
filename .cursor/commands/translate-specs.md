...
Executes the **spec-translator** skill: read `.cursor/skills/spec-translator/SKILL.md` and follow the procedure.
...
1. Execute:
   ```bash
   python .cursor/skills/spec-translator/scripts/translate_specs.py $ARGUMENTS
   ```
