...
Executes the **release-downloader** skill: read `.cursor/skills/release-downloader/SKILL.md` and follow the procedure.
...
2. Execute:
   ```bash
   python .cursor/skills/release-downloader/scripts/download_releases.py $ARGUMENTS
   ```
