...
Executes the **output-diff-analyzer** skill: read `.agent/skills/output-diff-analyzer/SKILL.md` and follow the procedure.
...
1. Execute:
   ```bash
   python .agent/skills/output-diff-analyzer/scripts/diff_output.py $ARGUMENTS
   ```
