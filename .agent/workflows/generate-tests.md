...
Executes the **test-generator** skill: read `.agent/skills/test-generator/SKILL.md` and follow the procedure.
...
2. Execute:
   ```bash
   python .agent/skills/test-generator/scripts/generate_tests.py $ARGUMENTS
   ```
