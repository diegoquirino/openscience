...
Executes the **src-diff-analyzer** skill: read `.agent/skills/src-diff-analyzer/SKILL.md` and follow the procedure.
...
1. Execute:
   ```bash
   python .agent/skills/src-diff-analyzer/scripts/diff_src.py $ARGUMENTS
   ```
